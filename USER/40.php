...
$sql = "SELECT * FROM cakes LIMIT 5 OFFSET 201"; // Adjust the LIMIT/OFFSET to your needs
...
<head>
    ...
    <title>Unique wedding cake</title>
</head>
<body>
<div class="content-wrapper">
    <!-- Left side: Cake Image and Details -->
    <div class="left-column">
        <img src="an50.jpg" alt="Unique wedding cake">
        <p>Unique wedding cake<br>
