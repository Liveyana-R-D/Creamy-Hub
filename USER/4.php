...
$sql = "SELECT * FROM cakes LIMIT 5 OFFSET 15"; // Adjust the LIMIT/OFFSET to your needs
...
<head>
    ...
    <title>Wafer chocolate cake</title>
</head>
<body>
<div class="content-wrapper">
    <!-- Left side: Cake Image and Details -->
    <div class="left-column">
        <img src="ch4.jpg" alt="Wafer chocolate cake">
        <p>Wafer chocolate cake<br>
