...
$sql = "SELECT * FROM cakes LIMIT 5 OFFSET 191"; // Adjust the LIMIT/OFFSET to your needs
...
<head>
    ...
    <title>Heart wedding cake</title>
</head>
<body>
<div class="content-wrapper">
    <!-- Left side: Cake Image and Details -->
    <div class="left-column">
        <img src="an40.jpg" alt="Heart wedding cake">
        <p>Heart wedding cake<br>
