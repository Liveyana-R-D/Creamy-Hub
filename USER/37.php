...
$sql = "SELECT * FROM cakes LIMIT 5 OFFSET 186"; // Adjust the LIMIT/OFFSET to your needs
...
<head>
    ...
    <title>4 layer wedding cake</title>
</head>
<body>
<div class="content-wrapper">
    <!-- Left side: Cake Image and Details -->
    <div class="left-column">
        <img src="an2.jpg" alt="4 layer wedding cake">
        <p>4 layer wedding cake<br>
