...
$sql = "SELECT * FROM cakes LIMIT 5 OFFSET 25"; // Adjust the LIMIT/OFFSET to your needs
...
<head>
    ...
    <title>Fruit chocolate cake</title>
</head>
<body>
<div class="content-wrapper">
    <!-- Left side: Cake Image and Details -->
    <div class="left-column">
        <img src="ch6.jpg" alt="Fruit chocolate cake">
        <p>Fruit chocolate cake<br>
