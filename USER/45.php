...
$sql = "SELECT * FROM cakes LIMIT 5 OFFSET 226"; // Adjust the LIMIT/OFFSET to your needs
...
<head>
    ...
    <title>Love red velvet</title>
</head>
<body>
<div class="content-wrapper">
    <!-- Left side: Cake Image and Details -->
    <div class="left-column">
        <img src="re6.webp" alt="Love red velvet">
        <p>Love red velvet<br>
