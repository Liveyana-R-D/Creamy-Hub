...
$sql = "SELECT * FROM cakes LIMIT 5 OFFSET 231"; // Adjust the LIMIT/OFFSET to your needs
...
<head>
    ...
    <title>Creamy red velvet</title>
</head>
<body>
<div class="content-wrapper">
    <!-- Left side: Cake Image and Details -->
    <div class="left-column">
        <img src="re3.webp" alt="Creamy red velvet">
        <p>Creamy red velvet<br>
