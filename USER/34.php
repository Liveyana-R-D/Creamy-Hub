...
$sql = "SELECT * FROM cakes LIMIT 5 OFFSET 171"; // Adjust the LIMIT/OFFSET to your needs
...
<head>
    ...
    <title>Yellow eggless cake</title>
</head>
<body>
<div class="content-wrapper">
    <!-- Left side: Cake Image and Details -->
    <div class="left-column">
        <img src="eg5.jpg" alt="Yellow eggless cake">
        <p>Yellow eggless cake<br>
