...
$sql = "SELECT * FROM cakes LIMIT 5 OFFSET 266"; // Adjust the LIMIT/OFFSET to your needs
...
<head>
    ...
    <title>Love black & white forest</title>
</head>
<body>
<div class="content-wrapper">
    <!-- Left side: Cake Image and Details -->
    <div class="left-column">
        <img src="b3.jpeg" alt="Love black & white forest">
        <p>Love black & white forest<br>
