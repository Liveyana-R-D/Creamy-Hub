...
$sql = "SELECT * FROM cakes LIMIT 5 OFFSET 101"; // Adjust the LIMIT/OFFSET to your needs
...
<head>
    ...
    <title>Blue theme cake</title>
</head>
<body>
<div class="content-wrapper">
    <!-- Left side: Cake Image and Details -->
    <div class="left-column">
        <img src="fb2.png" alt="Blue theme cake">
        <p>Blue theme cake<br>
