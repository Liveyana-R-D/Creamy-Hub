...
$sql = "SELECT * FROM cakes LIMIT 5 OFFSET 116"; // Adjust the LIMIT/OFFSET to your needs
...
<head>
    ...
    <title>Pooh theme cake</title>
</head>
<body>
<div class="content-wrapper">
    <!-- Left side: Cake Image and Details -->
    <div class="left-column">
        <img src="fb4.jpg" alt="Pooh theme cake">
        <p>Pooh theme cake<br>
