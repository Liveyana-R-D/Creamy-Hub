...
$sql = "SELECT * FROM cakes LIMIT 5 OFFSET 161"; // Adjust the LIMIT/OFFSET to your needs
...
<head>
    ...
    <title>Chocolate eggless cake</title>
</head>
<body>
<div class="content-wrapper">
    <!-- Left side: Cake Image and Details -->
    <div class="left-column">
        <img src="eg2.webp" alt="Chocolate eggless cake">
        <p>Chocolate eggless cake<br>
