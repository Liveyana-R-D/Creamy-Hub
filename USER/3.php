...
$sql = "SELECT * FROM cakes LIMIT 5 OFFSET 10"; // Adjust the LIMIT/OFFSET to your needs
...
<head>
    ...
    <title>Heart chocolate cake</title>
</head>
<body>
<div class="content-wrapper">
    <!-- Left side: Cake Image and Details -->
    <div class="left-column">
        <img src="ch3.png" alt="Heart chocolate cake">
        <p>Heart chocolate cake<br>
