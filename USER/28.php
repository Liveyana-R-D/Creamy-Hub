...
$sql = "SELECT * FROM cakes LIMIT 5 OFFSET 141"; // Adjust the LIMIT/OFFSET to your needs
...
<head>
    ...
    <title>Dry fruits cake</title>
</head>
<body>
<div class="content-wrapper">
    <!-- Left side: Cake Image and Details -->
    <div class="left-column">
        <img src="fr3.jpg" alt="Dry fruits cake">
        <p>Dry fruits cake<br>
