...
$sql = "SELECT * FROM cakes LIMIT 5 OFFSET 251"; // Adjust the LIMIT/OFFSET to your needs
...
<head>
    ...
    <title>3 layer white forest</title>
</head>
<body>
<div class="content-wrapper">
    <!-- Left side: Cake Image and Details -->
    <div class="left-column">
        <img src="b1.jpg" alt="3 layer white forest">
        <p>3 layer white forest<br>
