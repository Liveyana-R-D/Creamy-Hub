...
$sql = "SELECT * FROM cakes LIMIT 6 OFFSET 48"; // Adjust the LIMIT/OFFSET to your needs
...
<head>
    ...
    <title>White ribbon birthday cake</title>
</head>
<body>
<div class="content-wrapper">
    <!-- Left side: Cake Image and Details -->
    <div class="left-column">
        <img src="bd4.jpg" alt="White ribbon birthday cake">
        <p>White ribbon birthday cake<br>
