...
$sql = "SELECT * FROM cakes LIMIT 5 OFFSET 111"; // Adjust the LIMIT/OFFSET to your needs
...
<head>
    ...
    <title>Minnie theme cake</title>
</head>
<body>
<div class="content-wrapper">
    <!-- Left side: Cake Image and Details -->
    <div class="left-column">
        <img src="fb3.jpg" alt="Minnie theme cake">
        <p>Minnie theme cake<br>
