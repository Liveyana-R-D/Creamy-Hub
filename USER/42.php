...
$sql = "SELECT * FROM cakes LIMIT 5 OFFSET 211"; // Adjust the LIMIT/OFFSET to your needs
...
<head>
    ...
    <title>Elegant wedding cake</title>
</head>
<body>
<div class="content-wrapper">
    <!-- Left side: Cake Image and Details -->
    <div class="left-column">
        <img src="an10.jpg" alt="Elegant wedding cake">
        <p>Elegant wedding cake<br>
