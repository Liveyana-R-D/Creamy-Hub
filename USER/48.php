...
$sql = "SELECT * FROM cakes LIMIT 5 OFFSET 241"; // Adjust the LIMIT/OFFSET to your needs
...
<head>
    ...
    <title>Layered red velvet</title>
</head>
<body>
<div class="content-wrapper">
    <!-- Left side: Cake Image and Details -->
    <div class="left-column">
        <img src="re4.jpg" alt="Layered red velvet">
        <p>Layered red velvet<br>
