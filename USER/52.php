...
$sql = "SELECT * FROM cakes LIMIT 5 OFFSET 261"; // Adjust the LIMIT/OFFSET to your needs
...
<head>
    ...
    <title>Choco black forest</title>
</head>
<body>
<div class="content-wrapper">
    <!-- Left side: Cake Image and Details -->
    <div class="left-column">
        <img src="b2.webp" alt="Choco black forest">
        <p>Choco black forest<br>
