...
$sql = "SELECT * FROM cakes LIMIT 5 OFFSET 206"; // Adjust the LIMIT/OFFSET to your needs
...
<head>
    ...
    <title>Purple wedding cake</title>
</head>
<body>
<div class="content-wrapper">
    <!-- Left side: Cake Image and Details -->
    <div class="left-column">
        <img src="an60.jpg" alt="Purple wedding cake">
        <p>Purple wedding cake<br>
