...
$sql = "SELECT * FROM cakes LIMIT 5 OFFSET 66"; // Adjust the LIMIT/OFFSET to your needs
...
<head>
    ...
    <title>Colorful cupcakes</title>
</head>
<body>
<div class="content-wrapper">
    <!-- Left side: Cake Image and Details -->
    <div class="left-column">
        <img src="cc4.jpg" alt="Colorful cupcakes">
        <p>Colorful cupcakes<br>
