...
$sql = "SELECT * FROM cakes LIMIT 5 OFFSET 196"; // Adjust the LIMIT/OFFSET to your needs
...
<head>
    ...
    <title>Yellow wedding cake</title>
</head>
<body>
<div class="content-wrapper">
    <!-- Left side: Cake Image and Details -->
    <div class="left-column">
        <img src="an30.jpg" alt="Yellow wedding cake">
        <p>Yellow wedding cake<br>
