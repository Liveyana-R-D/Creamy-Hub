...
$sql = "SELECT * FROM cakes LIMIT 5 OFFSET 166"; // Adjust the LIMIT/OFFSET to your needs
...
<head>
    ...
    <title>Red velvet eggless cake</title>
</head>
<body>
<div class="content-wrapper">
    <!-- Left side: Cake Image and Details -->
    <div class="left-column">
        <img src="eg3.jpg" alt="Red velvet eggless cake">
        <p>Red velvet eggless cake<br>
