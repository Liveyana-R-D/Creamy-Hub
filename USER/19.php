...
$sql = "SELECT * FROM cakes LIMIT 5 OFFSET 96"; // Adjust the LIMIT/OFFSET to your needs
...
<head>
    ...
    <title>Pink theme cake</title>
</head>
<body>
<div class="content-wrapper">
    <!-- Left side: Cake Image and Details -->
    <div class="left-column">
        <img src="fb1.jfif" alt="Pink theme cake">
        <p>Pink theme cake<br>
