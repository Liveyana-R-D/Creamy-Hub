...
$sql = "SELECT * FROM cakes LIMIT 6 OFFSET 42"; // Adjust the LIMIT/OFFSET to your needs
...
<head>
    ...
    <title>Colourful birthday cake</title>
</head>
<body>
<div class="content-wrapper">
    <!-- Left side: Cake Image and Details -->
    <div class="left-column">
        <img src="bd3.jpg" alt="Colourful birthday cake">
        <p>Colourful birthday cake<br>
