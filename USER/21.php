...
$sql = "SELECT * FROM cakes LIMIT 5 OFFSET 106"; // Adjust the LIMIT/OFFSET to your needs
...
<head>
    ...
    <title>Jumbo theme cake</title>
</head>
<body>
<div class="content-wrapper">
    <!-- Left side: Cake Image and Details -->
    <div class="left-column">
        <img src="fb6.jpg" alt="Jumbo theme cake">
        <p>Jumbo theme cake<br>
