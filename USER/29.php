...
$sql = "SELECT * FROM cakes LIMIT 5 OFFSET 146"; // Adjust the LIMIT/OFFSET to your needs
...
<head>
    ...
    <title>Mixed fruit cake</title>
</head>
<body>
<div class="content-wrapper">
    <!-- Left side: Cake Image and Details -->
    <div class="left-column">
        <img src="fr5.webp" alt="Mixed fruit cake">
        <p>Mixed fruit cake<br>
