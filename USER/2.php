...
$sql = "SELECT * FROM cakes LIMIT 5 OFFSET 5"; // Adjust the LIMIT/OFFSET to your needs
...
<head>
    ...
    <title>Square chocolate cake</title>
</head>
<body>
<div class="content-wrapper">
    <!-- Left side: Cake Image and Details -->
    <div class="left-column">
        <img src="ch5.jpg" alt="Square chocolate cake">
        <p>Square chocolate cake<br>
