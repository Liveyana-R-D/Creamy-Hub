...
$sql = "SELECT * FROM cakes LIMIT 5 OFFSET 236"; // Adjust the LIMIT/OFFSET to your needs
...
<head>
    ...
    <title>Round red velvet</title>
</head>
<body>
<div class="content-wrapper">
    <!-- Left side: Cake Image and Details -->
    <div class="left-column">
        <img src="re1.jpg" alt="Round red velvet">
        <p>Round red velvet<br>
