...
if (!isset($_SESSION['user_id'])) { // Changed to check user_id
    header('Location: login.php');
    exit();
}

// Fetch cakes from the database for the dropdown
$sql = "SELECT * FROM cakes LIMIT 5"; // Adjust the LIMIT/OFFSET to your needs
...
<head>
    ...
    <title>Chocolate Cake with Wafers</title>
</head>
...
<div class="content-wrapper">
    ...
    <div class="left-column">
        <img src="ch1.jpg" alt="Chocolate Cake with Wafers">
        <p>Chocolate cake with Wafers<br>
