...
$sql = "SELECT * FROM cakes LIMIT 6 OFFSET 30"; // Adjust the LIMIT/OFFSET to your needs
...
<head>
    ...
    <title>3 layer birthday cake</title>
</head>
<body>
<div class="content-wrapper">
    <!-- Left side: Cake Image and Details -->
    <div class="left-column">
        <img src="bd1.jpg" alt="3 layer birthday cake">
        <p>3 layer birthday cake<br>
