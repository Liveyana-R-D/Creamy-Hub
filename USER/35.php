...
$sql = "SELECT * FROM cakes LIMIT 5 OFFSET 176"; // Adjust the LIMIT/OFFSET to your needs
...
<head>
    ...
    <title>Purple eggless cake</title>
</head>
<body>
<div class="content-wrapper">
    <!-- Left side: Cake Image and Details -->
    <div class="left-column">
        <img src="eg4.avif" alt="Purple eggless cake">
        <p>Purple eggless cake<br>
