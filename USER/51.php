...
$sql = "SELECT * FROM cakes LIMIT 5 OFFSET 256"; // Adjust the LIMIT/OFFSET to your needs
...
<head>
    ...
    <title>Choco white forest</title>
</head>
<body>
<div class="content-wrapper">
    <!-- Left side: Cake Image and Details -->
    <div class="left-column">
        <img src="b6.jpg" alt="Choco white forest">
        <p>Choco white forest<br>
