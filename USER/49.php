...
$sql = "SELECT * FROM cakes LIMIT 5 OFFSET 246"; // Adjust the LIMIT/OFFSET to your needs
...
<head>
    ...
    <title>Round black & white forest</title>
</head>
<body>
<div class="content-wrapper">
    <!-- Left side: Cake Image and Details -->
    <div class="left-column">
        <img src="b4.jpg" alt="Round black & white forest">
        <p>Round black & white forest<br>
