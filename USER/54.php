...
$sql = "SELECT * FROM cakes LIMIT 5 OFFSET 271"; // Adjust the LIMIT/OFFSET to your needs
...
<head>
    ...
    <title>Fruit black forest</title>
</head>
<body>
<div class="content-wrapper">
    <!-- Left side: Cake Image and Details -->
    <div class="left-column">
        <img src="b5.jpg" alt="Fruit black forest">
        <p>Fruit black forest<br>
