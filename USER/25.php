...
$sql = "SELECT * FROM cakes LIMIT 5 OFFSET 126"; // Adjust the LIMIT/OFFSET to your needs
...
<head>
    ...
    <title>Butter fruit cake</title>
</head>
<body>
<div class="content-wrapper">
    <!-- Left side: Cake Image and Details -->
    <div class="left-column">
        <img src="fr1.jfif" alt="Butter fruit cake">
        <p>Butter fruit cake<br>
