...
$sql = "SELECT * FROM cakes LIMIT 5 OFFSET 181"; // Adjust the LIMIT/OFFSET to your needs
...
<head>
    ...
    <title>Choco eggless cake</title>
</head>
<body>
<div class="content-wrapper">
    <!-- Left side: Cake Image and Details -->
    <div class="left-column">
        <img src="eg1.jfif" alt="Choco eggless cake">
        <p>Choco eggless cake<br>
