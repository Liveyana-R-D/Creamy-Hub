...
$sql = "SELECT * FROM cakes LIMIT 5 OFFSET 81"; // Adjust the LIMIT/OFFSET to your needs
...
<head>
    ...
    <title>Choco chip cupcakes</title>
</head>
<body>
<div class="content-wrapper">
    <!-- Left side: Cake Image and Details -->
    <div class="left-column">
        <img src="cc2.jpg" alt="Choco chip cupcakes">
        <p>Choco chip cupcakes<br>
