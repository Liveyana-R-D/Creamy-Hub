...
$sql = "SELECT * FROM cakes LIMIT 5 OFFSET 131"; // Adjust the LIMIT/OFFSET to your needs
...
<head>
    ...
    <title>Love fruit cake</title>
</head>
<body>
<div class="content-wrapper">
    <!-- Left side: Cake Image and Details -->
    <div class="left-column">
        <img src="fr2.jfif" alt="Love fruit cake">
        <p>Love fruit cake<br>
