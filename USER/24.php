...
$sql = "SELECT * FROM cakes LIMIT 5 OFFSET 121"; // Adjust the LIMIT/OFFSET to your needs
...
<head>
    ...
    <title>Princess theme cake</title>
</head>
<body>
<div class="content-wrapper">
    <!-- Left side: Cake Image and Details -->
    <div class="left-column">
        <img src="fb5.jpg" alt="Princess theme cake">
        <p>Princess theme cake<br>
