...
$sql = "SELECT * FROM cakes LIMIT 5 OFFSET 156"; // Adjust the LIMIT/OFFSET to your needs
...
<head>
    ...
    <title>Butterscotch eggless cake</title>
</head>
<body>
<div class="content-wrapper">
    <!-- Left side: Cake Image and Details -->
    <div class="left-column">
        <img src="eg6.jpg" alt="Butterscotch eggless cake">
        <p>Butterscotch eggless cake<br>
